    ...
    <div className="container mx-auto max-w-7xl px-4 py-8">
      ...
      >
        <div className="bg-muted/50 rounded-lg p-3 text-center sm:p-4 md:p-6">
          ...
          <h3 className="font-semibold text-xs sm:text-sm md:text-base leading-tight">Listos para cocinar</h3>
        ...
        <div className="bg-muted/50 rounded-lg p-3 text-center sm:p-4 md:p-6">
          ...
          <h3 className="font-semibold text-xs sm:text-sm md:text-base leading-tight">Recetas probadas</h3>
          <p className="text-xs text-muted-foreground mt-1 hidden sm:block">
      ...
      {all.length === 0 ? (
        ...
        <CategoryFilterBar allProducts={all} label="Elaborados">
